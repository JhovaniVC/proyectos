...
class ProductosProvider{
  ...
  final String _url = 'https://flutter-varios-e8f6e-default-rtdb.firebaseio.com/';
  ...
  Future<String> subirImage( File imagen ) async {
    ...
    final url  = Uri.parse('https://api.cloudinary.com/v1_1/dgofo0kfs/image/upload?upload_preset=cuufcjpo&=');
